...
def course_get_examples(token_info, course_id, task):
    return common_get_examples(token_info, course_id, task)

def contest_get_examples(token_info, contest_id, task):
    return common_get_examples(token_info, contest_id, task)
